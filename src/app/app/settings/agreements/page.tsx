  ...
  return (
    <>
      ...
      <div className="panel" id="agreements">
        <p className="ph">Every warehouse a broker sent you to carries that broker&rsquo;s non-solicit until the term runs out. With nothing on file the app assumes the broad version: 24 months from your last load, consignees included. Upload the signed broker-carrier agreement and the app uses the clause as written. A clause that names only the broker&rsquo;s shippers clears the warehouses you deliver to for that broker. The app shows the clause and the dates; read it with your attorney.</p>
        ...
        {me && !me.limits.agreements && <p className="hint">Uploading agreements to clear held warehouses is on Carrier and up. <Link href="/app/settings/billing" style={{ color: "var(--blue)" }}>See plans</Link>.</p>}
